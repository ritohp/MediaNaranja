      ...
      <section className="py-32 px-6 bg-white border-b border-orange-50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            <button 
              onClick={() => { localStorage.removeItem('mn_draft_song'); navigate('/crear-cancion?category=pareja'); }}
      ...
      <section className="py-32 px-6 bg-silk border-b border-pink-50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1 space-y-8">
            ...
            <button 
              onClick={() => { localStorage.removeItem('mn_draft_song'); navigate('/crear-cancion?category=mama'); }}
      ...
      <section className="py-32 px-6 bg-white border-b border-indigo-50 overflow-hidden">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <button 
              onClick={() => { localStorage.removeItem('mn_draft_song'); navigate('/crear-cancion?category=hijo'); }}
      ...
      <section className="py-32 px-6 bg-silk">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            ...
            <button 
              onClick={() => { localStorage.removeItem('mn_draft_song'); navigate('/crear-cancion?category=amigos'); }}
